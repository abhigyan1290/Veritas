...
# Source: Anthropic public pricing (https://docs.anthropic.com/en/docs/about-claude/pricing)
# Keys match API model identifiers; versioned names (e.g. "claude-3-5-sonnet-20241022")
# resolve to the base key via longest-prefix match.
